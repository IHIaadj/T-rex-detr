...
import re
import time 
from Image_grab import capture_screenshot, resize, midpoint
...
from datasets.trex_dataset import make_coco_transforms
...
@torch.no_grad()
def infer_image(orig_image, model, postprocessors, device, output_path):
    model.eval()
